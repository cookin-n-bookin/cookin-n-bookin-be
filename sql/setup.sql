...
('Honey Tahini Challah', 4, 295, 'active dry yeast, honey, tahini, large egg yolks, extra-virgin olive oil, large eggs, bread flour, Diamond Crystal kosher salt, sesame seeds', 4, null),
('Gingery Ground Beef with Lime and Herbs', 6, 60, 'cooked rice, ginger, garlic cloves, shallot, limes, soy sauce, sriracha, fish sauce, vegetable oil, 80% lean ground beef, kosher salt, cilantro', 5, null),
('Big Shells with Escarole, Chovies & Mozz', 2, 156, 'escarole or radicchio or kale, garlic cloves, oregano or thyme leaves, fresh whole-milk mozzarella, heavy cream, Parmesan cheese, kosher salt, extra-virgin olive oil, panko bread crumbs, oil-packed anchovy fillets, red pepper flakes, dried large pasta shells', 2, null),
('Garlicky Broccoli and Greens with Hazelnut and Coriander', 5, 160, 'garlic cloves, toasted hazelnuts, coriander seeds, olive oil, kosher salt, broccoli, lacinato kale, lemon, flaky sea salt', 3, null);
